...
const PPV_GRADINI_ELISA = {
  ...
  generalization: {
    ...
    sistema_elisa: [
      "La libreria di caption: 10,1% di riuso su Ottorini vs 71,8% su Elisa (top caption: 79 fan vs 1.283) — sistema di squadra, non legge del mestiere. L'EFFETTO dei template su Ottorini è conteso (contrasto etichettato loss-marked, ma la popolazione con caption riusata vince di più: 33,0% vs base 27,6%) → nessuna prescrizione finché non riconciliato",
