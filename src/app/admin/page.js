...
// V9.0 — admin hub mappato alla palette HOC Pro.
const C = {
...
const CARDS = [
  ...
  { href: "/admin/seniority", title: "Seniority", desc: "Tier Junior/Senior/Master auto-calcolati + override manuale", color: C.yellow },
  { href: "/admin/seed", title: "Seed demo data", desc: "Popola l'app con operatori fittizi + 60 giorni di sessioni", color: C.green },
  { href: "/admin/access", title: "Gestione accessi", desc: "Aggiungi/rimuovi admin via email, senza redeploy", color: C.red },
  { href: "/admin/ruoli", title: "Ruoli & capabilities", desc: "Assegna ruoli (multi) — predefiniti + custom", color: C.purple },
  { href: "/admin/ruoli-custom", title: "Ruoli custom", desc: "Crea ruoli personalizzati con capability e scope", color: C.purple },
  ...
  { href: "/admin/group-categories", title: "Categorie Group", desc: "Classifica i Group come Big/Medium/Small per filtro vista nella leaderboard", color: C.purple },
