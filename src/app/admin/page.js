...
const SHORTCUT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/retention",              title: "Retention creator", desc: "Concentrazione whale, coorti, LTV, dormienti (fan pseudonimizzati)", icon: Repeat },
