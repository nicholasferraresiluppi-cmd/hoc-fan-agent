...
export default function AnalyticsReportsPage() {
  ...
  return (
    <div style={{ padding: "32px 28px 80px", maxWidth: 1300, margin: "0 auto", color: CP.textPrimary, fontFamily: FONTS.body }}>
      ...
      {/* Login Google button — apre Google login in NUOVA TAB. Utente logga lì, torna qui, ricarica */}
      <div style={{ padding: "14px 16px", background: CP.surface, border: `1px solid ${CP.border}`, borderRadius: 10, marginBottom: 22 }}>
        <div style={{ fontSize: 12, color: CP.textSecondary, marginBottom: 10 }}>
          <strong>1.</strong> Click <em>"Accedi con Google"</em> → si apre una nuova tab del browser sulla pagina di login Google ufficiale.
          Fai il login lì col tuo account.<br/>
          <strong>2.</strong> Torna in questa tab e clicca <em>"Ho fatto login, riprova"</em> per ricaricare la pagina e ri-tentare l'embed con la sessione Google fresca.
        </div>
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <a
            href="https://accounts.google.com/ServiceLogin?continue=https%3A%2F%2Flookerstudio.google.com%2F"
            target="_blank"
            rel="noopener noreferrer"
            style={{
