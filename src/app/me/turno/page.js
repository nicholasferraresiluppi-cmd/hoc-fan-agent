...
import { Copy, Check, Clock, Snowflake, HelpCircle, Compass, Target, TrendingUp, GraduationCap } from "lucide-react";
...
// (#73) al cockpit d'azione. Niente qui entra negli score.
function SignalsStrip({ sig }) {
